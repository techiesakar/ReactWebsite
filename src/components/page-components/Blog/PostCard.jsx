  ...
  return (
    <div className="flex flex-col gap-4 shadow ">
      <div className="relative">
        ...
        <div className=" absolute bottom-0 left-0 flex translate-x-1/2 translate-y-1/2 flex-col items-center justify-between bg-sky-400 px-6 py-2 text-sm font-semibold text-white">
          <span>15</span>
          <span>Jan</span>
        </div>
      </div>
